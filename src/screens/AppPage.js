            ...
            >
                ...
                <div className='info__container'>
                    ...
                    >
                        ...
                        <div className='info__image info--right'>
                        </div>
                    </div>
                </div>
                ...
                <div className='info__container'>
                    ...
                    >
                        <div className='info__content info--right'>
                            ...
                            <p style={{ color: color.contrast }}>Workout sharer has some great features to help you have an easier time following your plan. Our timer will automatically set intervals to the plan you're subscribed to so that you never have to set intervals again, but you can if you want and the calendar will tell you which workouts to do on which days so that you have time to follow ythe plan.</p>
                        </div>
                        
                        <div className='info__image info--left'>
                        </div>
                    </div>
                </div>
