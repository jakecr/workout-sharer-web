                                                        ...
                                                        ? <div className='create-plan__set--inputs'>
...

                                                            {
                                                                ...
                                                                ? [<Input 
                                                                    ...
                                                                    onChange={(e) => e.target.value.match(/^[4-9]|10$/) && onChangeBasicWorkout({ day: dayIndex, workout: workoutIndex, key: 'repsForAssessment', value: e.target.value })} 
                                                                />
                                                                , <Input 
                                                                    key={(dayIndex * workoutIndex + .1) * .11111}
                                                                    name='Number of reps' 
                                                                    ...
                                                                    <div className='create-plan__set--inputs'>
...

                                                                        {
                                                                            ...
                                                                            ? [<Input 
                                                                                ...
                                                                                onChange={(e) => e.target.value.match(/^[4-9]|10$/) && onChangeSet({ day: dayIndex, workout: workoutIndex, set: setIndex, key: 'repsForAssessment', value: e.target.value })} 
                                                                            />
                                                                            , <Input 
                                                                                key={(dayIndex * workoutIndex + .1) * .11111}
                                                                                name='Number of reps' 
