                                                        ...
                                                        ? <div className='create-plan__set--inputs'>
...

                                                            {
                                                                ...
                                                                ? [<Input 
                                                                    ...
                                                                    onChange={(e) => e.target.value.match(/\b[4-9]|10\b/) && onChangeBasicWorkout({ day: dayIndex, workout: workoutIndex, key: 'repsForAssessment', value: e.target.value })} 
                                                                />
                                                                , <Input 
                                                                    key={(dayIndex * workoutIndex + .1) * .11111}
                                                                    name='Number of reps' 
                                                                    ...
                                                                    <div className='create-plan__set--inputs'>
...

                                                                        {
                                                                            ...
                                                                            ? [<Input 
                                                                                ...
                                                                                onChange={(e) => e.target.value.match(/\b[4-9]|10\b/) && onChangeSet({ day: dayIndex, workout: workoutIndex, set: setIndex, key: 'repsForAssessment', value: e.target.value })} 
                                                                            />
                                                                            , <Input 
                                                                                key={(dayIndex * workoutIndex + .1) * .11111}
                                                                                name='Number of reps' 
