                                                        ...
                                                        ? <div className='create-plan__set--inputs'>
...

                                                            {
                                                                ...
                                                                ? [<Input 
                                                                    ...
                                                                    onChange={(e) => e.target.value.match(/^[0-9]{0,1}|[1]{0,1}[0]{0,1}$/) && onChangeBasicWorkout({ day: dayIndex, workout: workoutIndex, key: 'repsForAssessment', value: e.target.value })} 
                                                                />
                                                                , <Input 
                                                                    key={(dayIndex * workoutIndex + .1) * .11111}
                                                                    name='Number of reps' 
                                                                    ...
                                                                    <div className='create-plan__set--inputs'>
...

                                                                        {
                                                                            ...
                                                                            ? [<Input 
                                                                                ...
                                                                                onChange={(e) => e.target.value.match(/^[0-9]{0,1}|[1]{0,1}[0]{0,1}$/) && onChangeSet({ day: dayIndex, workout: workoutIndex, set: setIndex, key: 'repsForAssessment', value: e.target.value })} 
                                                                            />
                                                                            , <Input 
                                                                                key={(dayIndex * workoutIndex + .1) * .11111}
                                                                                name='Number of reps' 
